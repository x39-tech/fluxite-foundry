// No longer used for new elements, use AppInput or TextEditorField
//
...
type Props = ComponentProps<"input"> & AppInputProps;

const AppInput = forwardRef<HTMLInputElement, Props>(function Input(
  {
    value,
    defaultValue,
    placeholder,
