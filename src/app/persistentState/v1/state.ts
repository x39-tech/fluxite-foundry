...
export const ParameterSchema = z.object({
  ...
  count: z.int().nonnegative().optional().catch(undefined),
  ...
  dynamicMinimum: z.number().optional(),
  dynamicMaximum: z.number().optional(),
...
// MappingGroup as entity - associates conditions with parameter mappings
...
export const AppStateSchema = z.object({
  ...
  deviceClassEditors: z.record(z.string(), DeviceClassEditorSchema),
});
